...
- [ ] Все три R2-метода получают именно те входы, что указаны в таблице агентов спецификации
- [ ] `_prepare_discussion` собирает строку с шестью секциями в правильном порядке
- [ ] Промпты соответствуют нодам R2 из `Support_new.json`
- [ ] При возврате `None` любым R2-агентом — исключение будет поймано в `answer()` (T05)
