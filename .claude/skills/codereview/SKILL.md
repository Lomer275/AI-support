...
name: codereview
description: >
  Многофазный придирчивый код-ревью задачи. Используй этот скилл всякий раз,
  когда пользователь просит проверить код, сделать ревью, найти баги, проверить
  критерии приёмки, или говорит "/codereview", "сделай ревью", "проверь код",
  "посмотри что не так", "найди баги", "code review". Скилл охватывает все фазы:
  проверку критериев приёмки, adversarial review, user walkthrough, архитектурный
  fit. Результат — структурированная таблица находок с severity и записью в файл задачи.
---
