...
# Extended descriptions to help Vision distinguish visually similar documents
_CHECKLIST_DESCRIPTIONS = {
    **CHECKLIST_ITEMS,
    "snils":                "СНИЛС — зелёная пластиковая карточка или бумажная справка СФР/ПФР с номером вида XXX-XXX-XXX XX. НЕ путать с пенсионным удостоверением.",
    "pension_certificate":  "Пенсионное удостоверение — красная или синяя книжечка с фото, либо справка о назначении пенсии. НЕ путать со СНИЛС.",
    "passport":             "Паспорт РФ — все страницы без обложки (разворот с фото, прописка, семейное положение и др.).",
    "inn_certificate":      "Свидетельство ИНН — бумажный документ с надписью 'Свидетельство о постановке на учёт' и 12-значным ИНН.",
    "bank_statements":      "Выписка по банковскому счёту — таблица транзакций с реквизитами банка, ФИО клиента, номером счёта.",
    "income_2ndfl":         "Справка 2-НДФЛ — стандартная форма ФНС с печатью работодателя, суммами дохода и налога по месяцам.",
    "debt_docs":            "Кредитный договор или справка о задолженности — документ банка/МФО с суммой долга, процентами, реквизитами.",
}
_CHECKLIST_LINES = "\n".join(f"- {k}: {v}" for k, v in _CHECKLIST_DESCRIPTIONS.items())
