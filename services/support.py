...
class SupportService:
    ...
    async def _r2_manager(
        ...
        system = (
            ...
            "⛔ ЗАПРЕТ: никогда не предлагай фразы с «управляющий», «финансовый управляющий», «арбитражный управляющий» "
    ...
    async def _coordinator(
        ...
        system = (
            ...
            "---\n\n"
            "5) САМОПРОВЕРКА ПЕРЕД ОТВЕТОМ: перед тем как сформировать JSON, задай себе два вопроса:\n"
